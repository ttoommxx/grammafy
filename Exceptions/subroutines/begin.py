...
exceptions = [e[:-3] for e in os.listdir("./Exceptions/subsubroutines/begin/")]
...
command = "./Exceptions/subsubroutines/begin/" + readText[1:t-1] + ".py"
if os.path.exists(command):
    ...
    print('error 404: "' + readText[1:t-1] + '" not found in ./Exceptions/subsubroutines/begin/')
